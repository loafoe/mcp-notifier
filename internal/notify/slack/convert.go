...
// convertMarkdownToMrkdwn converts common Markdown syntax to Slack's mrkdwn.
...
// renderTable converts a markdown table into Slack-friendly text: an inline
// "*header* | value" layout for narrow tables, or an aligned code block for
// wide ones.
